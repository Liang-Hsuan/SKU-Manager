...
namespace SKU_Manager.SKUExportModules.Tables.ChannelPartnerTables.ShopCaTables
{
     ...
     */
    class ShopCaBagExportTable : ExportTableFast
    {
        ...
        public override DataTable getTable()
        {
            ...
            foreach (DataRow row in table.Rows)
            {
                ...
                newRow[2] = row[24];                                     // sku
                newRow[3] = "Ashlin® " + row[0] + " " + row[21] + row[23];    // title
                ...
                newRow[8] = row[18];                                     // product type
                newRow[9] = row[25];                                     // main image location
                newRow[10] = row[37];                                    // standard product id
                newRow[11] = "UPC";                                      // standard product id type
                newRow[12] = true;                                       // availability
                newRow[13] = "Ashlin®";                                  // brand
                newRow[14] = row[26];                                    // launch date
                newRow[15] = row[36];                                    // release date
                ...
                newRow[27] = row[24];                                    // mfr part number
                newRow[28] = row[19];                                    // search term
                newRow[29] = row[24].ToString().Substring(0, row[24].ToString().IndexOf('-'));     // parent sku
                newRow[30] = 620977;                                     // secondary product category id
                newRow[31] = true;                                       // is new product
                newRow[32] = row[27];                                    // alt iamge location 1
                newRow[33] = row[28];                                    // alt iamge location 2
                newRow[34] = row[29];                                    // alt iamge location 3
                newRow[35] = row[30];                                    // alt iamge location 4
                newRow[36] = row[31];                                    // alt iamge location 5
                newRow[37] = row[32];                                    // alt iamge location 6
                newRow[38] = row[33];                                    // alt iamge location 7
                newRow[39] = row[34];                                    // alt iamge location 8
                newRow[40] = row[35];                                    // alt iamge location 9
                newRow[42] = row[20];                                    // material
                newRow[43] = row[22];                                    // colour
                newRow[44] = row[0];                                     // style
                newRow[45] = row[12];                                    // trend
                if ((bool)row[6] && (bool)row[7])                        // strap type
                {
                ...
                if ((bool)row[8])                                         // colsure type
                {
                    newRow[47] = "Zippered enclosure";
                }
                newRow[48] = row[9] + "cm x " + row[10] + "cm x " + row[11] + "cm";                         // generic size
                newRow[49] = row[13] + " " + row[14] + " " + row[15] + " " + row[16] + " " + row[17];       // features

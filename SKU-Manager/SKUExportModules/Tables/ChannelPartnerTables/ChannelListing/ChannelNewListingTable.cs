...
namespace SKU_Manager.SKUExportModules.Tables.ChannelPartnerTables.ChannelListing
{
     ...
     */
    public class ChannelNewListingTable : ChannelListingExportTable
    {
        ...
        protected sealed override string[] getSku()
        {
            ...
            SqlCommand command = new SqlCommand("SELECT SKU_Ashlin FROM master_SKU_Attributes WHERE Active = 'True' AND (SKU_BESTBUY_CA = 'NEW' OR SKU_AMAZON_CA = 'NEW' OR "
                                              + "SKU_AMAZON_COM = 'NEW' OR SKU_STAPLES_CA = 'NEW' OR SKU_WALMART_CA = 'NEW' OR SKU_SHOP_CA = 'NEW' OR SKU_SEARS_CA = 'NEW');", connection);
            connection.Open();

    ...
    */
    class InactiveMaterialTable : ActiveInactiveTable
    {
        ...
        protected override DataTable getTable()
        {
            ...
            {
                SqlDataAdapter adapter = new SqlDataAdapter("SELECT Material_Code, Material_Description_Short, Material_Description_Short_FR, Material_Description_Extended, Material_Description_Extended_FR, Active FROM ref_Materials WHERE Active = 'False' ORDER BY Material_Code;", connection);
                connection.Open();

...
namespace SKU_Manager.ActiveInactiveList.ActiveInactiveTables
{
    ...
    public class ActiveDesignTable : ActiveInactiveTable
    {
        ...
        private ArrayList GetData(string designCode)
        {
            ...
            // [0] design service code, [1] brand, [2] design service flag, [3]cdesign service family code, [4] ashlin internal name, [5] short description, [6] extended description, [7] trend short description, [8] trend extended description, [9] online description, [10] gift box, [11] imprintable, [12] imprintable height,
            // [13] imprintable width, [14] width, [15] height, [16] depth, [17] weight, [18] flat shippable, [19] fold shippable, [20] shippable width, [21] shippable height, [22] shippable depth, [23] shippable weight, [24] detachable strap, [25] zippered enclosure, [26] country, [27] shoulder drop length, [28] handle strap drop length,
            // [29] notable strap or general feature, [30] protective feet, [31] closure, [32] inner pocket, [33] outside pocket, [34] size differentiation, [35] dust bag, [36] authenticity card, [37] bill compartment, [38] card slot, [39] option 1, [40] option 2, [41] option 3, [42] option 4, [43] option 5, [44] active
            SqlCommand command = new SqlCommand("SELECT Design_Service_Code, Brand, Design_Service_Flag, Design_Service_Family_Code, Design_Service_Fashion_Name_Ashlin, Short_Description, Extended_Description, Trend_Short_Description, Trend_Extended_Description, Design_Online, GiftBox, Imprintable, Imprint_Height_cm, Imprint_Width_cm, " + 
                                                "Width_cm, Height_cm, Depth_cm, Weight_grams, Flat_Shippable, Fold_Shippable, Shippable_Width_cm, Shippable_Height_cm, Shippable_Depth_cm, Shippable_Weight_grams, Detachable_Strap, Zippered_Enclosure, Country, ShoulderDropLength, HandleStrapDropLength, NotableStrapGeneralFeatures, ProtectiveFeet, " + 
                                                "Closure, InnerPocket, OutsidePocket, SizeDifferentiation, Dust_Bag, Authenticity_Card, Bill_Compartment, Card_Slot, Option_1, Option_2, Option_3, Option_4, Option_5, Active " +

...
namespace SKU_Manager.ActiveInactiveList.ActiveInactiveTables
{
     ...
     */
    class ActiveColorTable : ActiveInactiveTable
    {
        ...
        protected override DataTable getTable()
        {
            ...
            {
                SqlDataAdapter adapter = new SqlDataAdapter("SELECT Colour_Code, Colour_Description_Short, Colour_Description_Short_FR, Colour_Description_Extended, Colour_Description_Extended_FR, Active FROM ref_Colours WHERE Active = 'True' ORDER BY Colour_Code;", connection);
                connection.Open();

...
namespace SKU_Manager.SupportingClasses.Photo
{
    ...
    public static class ImageSearch
    {
        ...
        public static string[] GetImage(string sku)
        {
        ...
        public static string[] GetGroup(string sku)
        {
            // get the design service code for the product
            string prefix = sku.Substring(0, sku.IndexOf('-'));
        ...
        public static string[] GetModel(string sku)
        {
            // get the design service code for the product
            string prefix = sku.Substring(0, sku.IndexOf('-'));
        ...
        public static string[] GetTemplate(string sku)
        {
        ...
        public static string[] GetImageUri(string sku)
        {
            // get the design service code for the product
            string prefix = sku.Substring(0, sku.IndexOf('-'));
        ...
        public static string[] GetGroupUri(string sku)
        {
            // get the design service code for the product
            string prefix = sku.Substring(0, sku.IndexOf('-'));
        ...
        public static string[] GetModelUri(string sku)
        {
            // get the design service code for the product
            string prefix = sku.Substring(0, sku.IndexOf('-'));
        ...
        public static string[] GetTemplateUri(string sku)
        {
            // get the design service code for the product
            string prefix = sku.Substring(0, sku.IndexOf('-'));
